...
import type { NavItem, NavPageConfig, NavActiveState } from '@/shared/config/navTypes';
...
export type { NavPageConfig, NavActiveState, NavLeaf, NavSectionLink } from '@/shared/config/navTypes';
